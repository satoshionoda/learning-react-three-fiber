import { MaskedContent } from "@apps/examples/basics/stencil-mask/components/MaskedContent.tsx";
import { Target } from "@apps/examples/basics/stencil-mask/components/Target.tsx";
import {
  ContactShadows,
  Environment,
  Float,
