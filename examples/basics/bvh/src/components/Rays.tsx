...
const cyl = new CylinderGeometry(0.02, 0.02);
const sph = new SphereGeometry(0.25, 20, 20);
const bas = new MeshBasicMaterial();
const tra = new MeshBasicMaterial({ transparent: true, opacity: 0.25 });
