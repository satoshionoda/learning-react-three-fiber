...
loader.load("/assets/img1.jpg", (tex) => {
  uniforms.uImgB.value = tex as THREE.DataTexture;
});
loader.load("/assets/mask1.jpg", (tex) => {
  uniforms.uMask.value = tex as THREE.DataTexture;
});
